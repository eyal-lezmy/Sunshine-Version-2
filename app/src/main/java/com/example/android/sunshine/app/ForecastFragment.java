...
public class ForecastFragment extends Fragment {
    ...
    public static final int NUM_FORECAST_DAYS = 7;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //we fetch the weather forecast
//        processForecastRequest();
    }

    protected String[] processForecastRequest() {
        String[] forecasts = null;
        // Get the forecast as JSON from the cloud
        String forecastJsonStr = fetchForecastFromNetwork(NUM_FORECAST_DAYS, "paris");
    ...
    @Nullable
    private String fetchForecastFromNetwork(int numDays, String city) {
